...
public class CodebaseLanguageDetector
{
    ...
    private static readonly Regex NonAsciiPattern = new(@"[\u0400-\u04FF\u4E00-\u9FFF\u3040-\u309F\u30A0-\u30FF\u3400-\u4DBF]+", RegexOptions.Compiled);
    ...
    public class LanguageStats
    {
        ...
        public double NonEnglishPercentage => TotalWords > 0 ? (double)NonEnglishWords / TotalWords * 100 : 0;
    ...
    private static void AnalyzeText(string text, LanguageStats stats)
    {
        ...
        foreach (Match match in nonAsciiMatches)
        {
            ...
            else
            {
                ...
                var words = nonAsciiText.Split(new[] { ' ', '\t', '\n', '\r' }, StringSplitOptions.RemoveEmptyEntries);
    ...
    private static bool IsCommonKeyword(string word)
    {
        ...
        return word is "var" or "int" or "string" or "bool" or "void" or "null" or
               "true" or "false" or "get" or "set" or "if" or "else" or "for" or
               "while" or "return" or "new" or "this" or "base" or "using" or
               "namespace" or "class" or "public" or "private" or "static" or
               "async" or "await" or "task" or "list" or "dict" or "array";
    }
