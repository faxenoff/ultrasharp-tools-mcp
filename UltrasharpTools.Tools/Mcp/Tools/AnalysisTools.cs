...
public static partial class AnalysisTools {
    ...
    public static async Task<object> ManageUsings(
        ...
        return await ErrorHandlingHelpers.ExecuteWithErrorHandlingAsync(async () => {
            ...
            await ToolHelpers.EnsureSolutionLoadedOrAutoLoadAsync(solutionManager, logger, nameof(ManageUsings), cancellationToken);
    ...
    public static async Task<string> AnalyzeComplexity(
        ...
        return await ErrorHandlingHelpers.ExecuteWithErrorHandlingAsync(async () => {
            ...
            // Ensure solution is loaded
            await ToolHelpers.EnsureSolutionLoadedOrAutoLoadAsync(solutionManager, logger, nameof(AnalyzeComplexity), cancellationToken);
