...
public static class DocumentTools {
    ...
    public static async Task<string> ReadRawFromRoslynDocument(
        ...
        return await ErrorHandlingHelpers.ExecuteWithErrorHandlingAsync(async () => {
            ...
            await ToolHelpers.EnsureSolutionLoadedOrAutoLoadAsync(solutionManager, logger, nameof(ReadRawFromRoslynDocument), cancellationToken);
    ...
    public static async Task<string> CreateRoslynDocument(
        ...
        return await ErrorHandlingHelpers.ExecuteWithErrorHandlingAsync(async () => {
            ...
            await ToolHelpers.EnsureSolutionLoadedOrAutoLoadAsync(solutionManager, logger, nameof(CreateRoslynDocument), cancellationToken);
    ...
    public static async Task<string> OverwriteRoslynDocument(
        ...
        return await ErrorHandlingHelpers.ExecuteWithErrorHandlingAsync(async () => {
            ErrorHandlingHelpers.ValidateStringParameter(filePath, "filePath", logger);
            ErrorHandlingHelpers.ValidateStringParameter(content, "content", logger);
            await ToolHelpers.EnsureSolutionLoadedOrAutoLoadAsync(solutionManager, logger, nameof(OverwriteRoslynDocument), cancellationToken);
            content = content.TrimBackslash();
    ...
    public static async Task<object> ReadTypesFromRoslynDocument(
        ...
        return await ErrorHandlingHelpers.ExecuteWithErrorHandlingAsync(async () => {
            ...
            await ToolHelpers.EnsureSolutionLoadedOrAutoLoadAsync(solutionManager, logger, nameof(ReadTypesFromRoslynDocument), cancellationToken);
