...
**Умный инструмент работы с C# кодом для вас и вашего ИИ**
  ...
  **Умный merge:**
  ...
  Три процесса:
  - **Comm** — лёгкий мост (~5 MB), запускается у каждого агента
  - **Droid** — основной Roslyn-сервер (singleton)
  - **VectorDB** — семантический движок (lazy start)

  Сколько бы агентов ни работало — основной процесс всегда один.
  Экономия до 10 GB RAM.


---
Данный проект работает только с C#.
Для проектов с JS/TS/Python - используйте аналогичный [ultrascript-tools-mcp](https://github.com/faxenoff/ultrascript-tools-mcp)
...
|--------------|----------|
| **Общие ресурсы** | 5 редакторов используют ОДИН Droid+VectorDB вместо 5 копий (экономия 2-3 GB RAM на процесс) |
