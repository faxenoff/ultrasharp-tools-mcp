...
var timestamp = DateTime.UtcNow.AddSeconds(-lineCount + i).ToString("yyyy-MM-dd HH:mm:ss.fff");
...
private async Task<List<string>> SlidingWindowReadAsync(string filePath, string keyword, int take, int contextLines)
{
var results = new List<string>();
