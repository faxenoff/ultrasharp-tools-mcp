...
private double CalculateCosineSimilarityScalar(Dictionary<string, int> vec1, Dictionary<string, int> vec2)
{
...
private double CalculateCosineSimilaritySIMD(Dictionary<string, int> vec1, Dictionary<string, int> vec2)
{
if (!vec1.Any() && !vec2.Any()) return 1.0;
if (!vec1.Any() || !vec2.Any()) return 0.0;
