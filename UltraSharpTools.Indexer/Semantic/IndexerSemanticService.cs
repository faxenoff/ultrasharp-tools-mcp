...
using UltraSharpTools.Indexer.Semantic.Models;

namespace UltraSharpTools.Indexer.Semantic;
...
/// </summary>
public sealed class IndexerSemanticService : IAsyncDisposable
{
    private readonly VectorStore _vectorStore;
    private readonly EmbeddingGenerator _embeddingGenerator;
    private readonly ILogger<IndexerSemanticService> _logger;

    public IndexerSemanticService(
        VectorStore vectorStore,
        EmbeddingGenerator embeddingGenerator,
        ILogger<IndexerSemanticService> logger)
    {
