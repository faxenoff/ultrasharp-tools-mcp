...
if %errorlevel% equ 0 (
    ...
    pwsh -ExecutionPolicy Bypass -File "%~dp0Scripts\setup-semantic-embedding.ps1" %*
    goto :end
)

REM Fallback to Windows PowerShell
echo Using Windows PowerShell...
powershell -ExecutionPolicy Bypass -File "%~dp0Scripts\setup-semantic-embedding.ps1" %*
